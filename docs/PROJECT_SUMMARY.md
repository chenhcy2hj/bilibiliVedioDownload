...
| **v0.1.1 实施（当前）** | **P1 许可免责 ✅ / P2 批量≤10 ✅ / P3 历史持久化 ✅ / P4 历史重试 ✅ / P5 Chromium 捆绑 ✅ / P6 发布+双平台真机验收 ✅（v0.1.1：mac 248MB / win 276MB；Windows stdio 崩溃修复版已重发）** | ✅ 完成 |

**下一步（接续点）**：v0.1.1 已闭环。后续按 `docs/roadmap.md` §2 候选推进（高优先：CI 测试门禁、任务历史清空/搜索、真实 Windows 验收沉淀）；或开启 v0.1.2 迭代（先更新 roadmap/design 再实施）。
